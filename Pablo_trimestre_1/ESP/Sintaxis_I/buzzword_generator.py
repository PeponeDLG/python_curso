...
def generateRandomBuzzWord():
    ...
    """
    col1 = randint(0, 9)  # genera un entero aleatorio entre 0 y 9
    col2 = randint(0, 9)  # genera un entero aleatorio entre 0 y 9
    col3 = randint(0, 9)  # genera un entero aleatorio entre 0 y 9
    return getBuzzWord(col1, col2, col3)


def generateBuzzWord(id):
    """
    Usamos un unico numero de 3 cifras (entre 0 y 999)
    que define nuestro buzzWord
    """
