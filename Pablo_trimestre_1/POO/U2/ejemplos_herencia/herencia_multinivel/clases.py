# Herencia es la capacidad de una clase derivada heredar atributos y métodos de una clase base.
# La clase base se conoce como clase padre o superclase, mientras que la clase derivada se conoce como clase hija o subclase.
...
class TecnicoRedes(Informatico):
    def __init__(self, nombre, apellidos, altura, edad, especialidad):
        super().__init__(nombre, apellidos, altura, edad)
