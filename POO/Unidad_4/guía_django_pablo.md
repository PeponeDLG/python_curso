...
7. Aplicar migraciones para evitar problemas (Después de crear los modelos de BBDD):
...
Es probable que nos pida instalar:
`pip install mysqlclient`

Django proporciona acceso a base de datos MySQL, sin tener que instalar el paquete pymysql.
