    ...
    try:
        ...
        with connect(
            ...
            with conexion.cursor() as cursor:
                sql = 'SELECT codigoProducto, nombreProducto, categoriaProducto FROM productos where categoriaProducto="'+categoria+'"'
